...
#paths = glob.glob("G:/Versuch Rotorblatttorsion Yaw Anderung Torsion/Animation/ohne yaw Anderung/Torsion/Tor_*")
paths = glob.glob("G:/Versuch Rotorblatttorsion Yaw Anderung Torsion/Animation/Perfektes Licht/alte Triangulation/Torsion/Tor_*")

#paths = glob.glob("G:/Versuch Black_Top_Hat_Test/Original/Torsion/Tor_*")
#paths = glob.glob("G:/Versuch Black_Top_Hat_Test/Original Black-Top-Hat/Torsion/Tor_*")
#paths = glob.glob("G:/Versuch Black_Top_Hat_Test/Reflexion/Torsion/Tor_*")
paths = glob.glob("G:/Versuch Black_Top_Hat_Test/Reflexion mit Black-Top-Hat/Torsion/Tor_*")


#paths = glob.glob("G:/Versuch Black_Top_Hat_Test/Reflexion/Torsion_GP/Tor_*")


#[r"E:\HiWi Cordova\Messung 19_noyaw\out\DEFAULT\Torsion", r"E:\HiWi Cordova\Messung 19_noyaw\out\YAW_AVE\Torsion", r"E:\HiWi Cordova\Messung 19_noyaw\out\YAW_F0\Torsion"] #[r"E:\HiWi Cordova\Messung 19_noyaw\out\DEFAULT\Torsion", r"E:\HiWi Cordova\Messung 19_noyaw\out\YAW_F0\Torsion"]

base = easygui.diropenbox("Select Folder with out-Files") #[r"E:\HiWi Cordova\Messung 19_noyaw\out\ANGEL\Torsion"]#[r"E:\HiWi Cordova\Messung24\plots\DEFAULT\Torsion", r"E:\HiWi Cordova\Messung24\plots\YAW_AVE\Torsion", r"E:\HiWi Cordova\Messung24\plots\YAW_F0\Torsion"]
...
if len(diff_list) > 0:
    for i in range(len(diff_list)):
        print(names[i],  ": Mean: ", np.nanmean(np.abs(diff_list[i])),  "  Sdt: ", np.std(np.abs(diff_list[i])),  "  Max: ", np.max(np.abs(diff_list[i])))    
